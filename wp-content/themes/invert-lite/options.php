...
function optionsframework_options() {
	...
	$options[] = array(
		...
		$options[] = array(
			'name' => __('Sticky Header Background Color:', 'invert'),
			'desc' => __('Choose sticky header background color.', 'invert'),
	...
	//Front Page Options	
	$options[] = array(
			'name' => __('Home Header Image', 'invert'),
			'type' => 'heading');
		
		$options[] = array(
			'name' => __('Home Header Image:', 'invert'),
			'desc' => __('Choose image for home page header. Size: Width 1583px and Height 716px.', 'invert'),
	...
	// Front Featured Box
	 $options[] = array(
		...
		$options[] = array(
			'name' => __('Home Featured Box Enable/Disable:', 'invert'),
			'desc' => __('Radio select with default options "Enable".', 'invert'),
			'id' => $invert_shortname.'_hide_featured_box',
			'std' => 'true',
			'type' => 'radio',
	...
	// Front Call To Action
	 $options[] = array(
		...
		$options[] = array(
			'name' => __('Home Call to Action Enable/Disable:', 'invert'),
			'desc' => __('Radio select with default options "Enable".', 'invert'),
			'id' => $invert_shortname.'_hide_callto_action',
			'std' => 'true',
			'type' => 'radio',
			'options' => $breadcumhide_array);
	...
	//  Front Parallax
	$options[] = array(
		'name' => __('Home Parallax', 'invert'),
		'type' => 'heading');
		
		$options[] = array(
			'name' => __('Home Parallax Enable/Disable:', 'invert'),
			'desc' => __('Radio select with default options "Enable".', 'invert'),
			'id' => $invert_shortname.'_hide_parallax',
			'std' => 'true',
			'type' => 'radio',
			'options' => $breadcumhide_array);

		$options[] = array(
			'name' => __('Home Parallax Image ', 'invert'),
			'desc' => __('Choose hom page parallax image. Size: Width 1600px and Height 800px.', 'invert'),
			'id' => $invert_shortname.'_fullparallax_image',
			'std' => $imagepath.'PArallax_Vimeo_bg.jpg',
			'type' => 'upload');

		$options[] = array(
			'name' => __('Home Parallax Content:', 'invert'),
			'desc' => __('Enter parallax content.','invert'),
			'id' => $invert_shortname.'_para_content_left',
			'std' => '<div style="color:#fff"><div style="color:#fff"><div class="skt-ctabox"><div class="skt-ctabox-content"><h2>Awesome Parallax Section</h2><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. onec consequat malesuada urna, non fringilla purus malesuada eget.Lorem ipsum dolor sit amet, consectetur adipiscing elit. onec consequat malesuada urna, non fringilla purus malesuada eget.Lorem ipsum dolor sit amet, consectetur adipiscing elit. onec consequat malesuada urna, non fringilla purus malesuada eget.</p></div><div class="skt-ctabox-button"><a class="skt-ctabox-button" href="javascript:void(0)">Demo</a></div></div></div></div>',
			'type' => 'textarea');

	// Front Client
	$options[] = array(
		'name' => __('Home Blog Settings', 'invert'),
		'type' => 'heading');

	$options[] = array(
			'name' => __('Home Blog Section Enable/Disable:', 'invert'),
			'desc' => __('Radio select with default options "Enable".', 'invert'),
			'id' => $invert_shortname.'_hide_home_blog',
			'std' => 'true',
			'type' => 'radio',
			'options' => $breadcumhide_array);

	$options[] = array(
			'name' => __('Blog Section Title:', 'invert'),
			'desc' => __('Enter blog section title.', 'invert'),
			'id' => $invert_shortname.'_blogsec_title',
			'std' => 'Latest News',
			'type' => 'text');

	$options[] = array(
			'name' => __('Number of post:', 'invert'),
			'desc' => __('Enter number of post.', 'invert'),
			'id' => $invert_shortname.'_blog_no',
			'std' => '6',
			'type' => 'text');
	...
	// Front Client
	$options[] = array(
		'name' => __('Home Client Logo', 'invert'),
		'type' => 'heading');
		
		$options[] = array(
			'name' => __('Home Client Logos Enable/Disable:', 'invert'),
			'desc' => __('Radio select with default options "Enable".', 'invert'),
			'id' => $invert_shortname.'_hide_client_logo',
			'std' => 'true',
			'type' => 'radio',
			'options' => $breadcumhide_array);

		$options[] = array(
			'name' => __('Client Title:', 'invert'),
			'desc' => __('Enter client title.', 'invert'),
	...
	$options[] = array(
			...
			'desc' => __('Select breadcrumb background type. Default ( image ).', 'invert'),
    ...
    $options[] = array(
			'name' => __('Breadcrumb Background Color', 'invert'),
			'desc' => __('Select breadcrumb background color. No color selected by default.', 'invert'),
    ...
    $options[] = array(
			'name' => __('Breadcrumb Background Image (size: 1600px width and 450px height)', 'invert'),
			'desc' => __('Upload breadcrumb background image.', 'invert'),
	...
	$options[] = array(
			'name' => __('Breadcrumb Text Color', 'invert'),
			'desc' => __('Select breadcrumb text color. No color selected by default.', 'invert'),
