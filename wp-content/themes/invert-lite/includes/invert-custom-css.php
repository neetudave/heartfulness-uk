...
if(sketch_get_option($invert_shortname.'_bread_title_color')){ $breadtitlecolor = sketch_get_option($invert_shortname.'_bread_title_color'); } 
...
$parallaximage =  get_template_directory_uri() . '/images/PArallax_Vimeo_bg.jpg';
?>
...
.full-bg-image-fixed { background-image: url("<?php if(isset($fullparallax_image)){ echo $fullparallax_image; } else { echo $parallaximage; } ?>"); }
