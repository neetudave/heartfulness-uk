...
<div id="wrapper" class="skepage">
	...
	<!-- header image section -->
		...
		<div class="flexslider">
			<div class="post"><img alt="invert-default-slider-image" class="default-slider-image"  src="<?php if(sketch_get_option($invert_shortname.'_frontslider_stype')) { echo sketch_get_option($invert_shortname.'_frontslider_stype'); } else { echo esc_url(get_template_directory_uri().'/images/invert.jpg'); } ?>" ></div>
		</div>
