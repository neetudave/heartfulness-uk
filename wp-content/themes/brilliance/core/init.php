...
if(!function_exists('cpotheme_setup')){
	...
	function cpotheme_setup(){
		...
		if(!defined('CPOTHEME_PREMIUM_NAME')) define('CPOTHEME_PREMIUM_NAME', __('Premium Version', 'brilliance'));
		...
		load_theme_textdomain('brilliance', $languages_path);
		$locale = get_locale();
