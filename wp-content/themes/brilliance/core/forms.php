...
if(!function_exists('cpotheme_form_imagelist')){
	function cpotheme_form_imagelist($name, $value, $list, $args = null) {    
		...
		foreach ($list as $list_key => $list_value) {
			...
			$output .= '<label class="form_image_list_item" for="'.$name.'_'.$list_key.'"><img '.$selected.' src="'.esc_url($list_value).'" alt="'.$list_key.'"/><br/>';
